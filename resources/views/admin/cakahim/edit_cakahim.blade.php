    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md">
                        <h3 class="my-4 pl-2" style="border-left: solid black 5px">Verifikasi Cakahim</h3>
                        <div class="card card-body" id="show">
                          <form method="POST" action="{{ route('update_cakahim', $idcakahim) }}" enctype="multipart/form-data">
                              @csrf
                              @method('patch')
                              <div class="col-md-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="foto">Foto Calon</label>
